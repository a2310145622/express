...
function check(cpwd) {
	...
	{
		warn = document.getElementById("warning1");
	...
	var post ="cpwd=" + cpwd;
	xmlhttp.open("POST","doCheckPassword",true);
	xmlhttp.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	xmlhttp.send(post);
}

function validate() {  
    pwd = document.getElementById("inputncpwd");
    cpwd = document.getElementById("confirmncpwd");
...
<body>
	...
	<div class="container">
	  <div class="row">
		...
		<form class="form-signin" action="doModifyPWD" method="post">
		    <div>
			...
			<input type="password" id="inputncpwd" name="ncpwd" class="form-control"
			       placeholder="输入新密码" required="" onchange="validate()">
			<label for="confirmncpwd" class="sr-only">确认新密码</label>
			<input type="password" id="confirmncpwd" name="cncpwd" class="form-control"
			       placeholder="确认新密码" required="" onchange="validate()">
