		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="queryClientList">客户信息列表<span class="sr-only">(current)</span></a></li>
						...
						<tfoot>
							<tr>
								<td colspan="4"><span> 当前第 ${clients.currentPage} 页
										/ 总共 ${clients.totalPages} 页 </span> <c:if
										test="${clients.currentPage>1}">
