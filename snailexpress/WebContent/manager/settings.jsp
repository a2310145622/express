	  ...
	  <div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li class="active"><a href="settings">设置<span class="sr-only">(current)</span></a></li>
				</ul>
				<ul class="nav nav-sidebar">
		...
		<div id="navbar" class="navbar-collapse collapse">
		<form class="form-signin" action="doStaffModify" method="post">
			<h2 class="form-signin-heading">设置</h2>
			<label for="inputsid">账号</label>
			<input type="text" id="inputsid" name="sid" class="form-control"
                   placeholder="账号" required="" readonly value="<%=request.getAttribute("sid")%>">
            <label for="inputspwd">密码</label>
			<input type="text" id="inputspwd" name="spwd" class="form-control"
                   placeholder="密码" required="" autofocus=""  value="<%=request.getAttribute("spwd")%>">
            <label for="inputsname">姓名</label>
            <input type="text" id="inputsname" name="sname" class="form-control"
                   placeholder="姓名" required="" value="<%=request.getAttribute("sname")%>">
            <label for="inputsnumber">编号</label>
            <input type="text" id="inputsnumber" name="snumber" class="form-control"
                   placeholder="编号" required="" value="<%=request.getAttribute("snumber")%>">
            <label for="inputslphone">电话</label>
			<input type="text" id="inputslphone" name="slphone" class="form-control"
			       placeholder="电话" value="<%=request.getAttribute("slphone")%>">
			<label for="inputsremark">备注</label>
			<input type="text" id="inputsremark" name="sremark" class="form-control"
			       placeholder="备注"  value="<%=request.getAttribute("sremark")%>">
