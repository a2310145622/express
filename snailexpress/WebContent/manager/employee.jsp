	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				...
				<ul class="nav nav-sidebar">
					<li><a href="queryExpressList">快递单管理</a></li>
					<li><a href="queryClientList">客户户管理</a></li>
					<li class="active"><a href="employee.jsp">员工管理<span
							class="sr-only">(current)</span></a></li>
					<li><a href="queryStaffList">管理员管理</a></li>
				</ul>
			</div>
