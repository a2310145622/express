	  ...
	  <div class="row">
		<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class="active"><a href="settings">个人信息<span class="sr-only">(current)</span></a></li>
		...
		<form class="form-signin">
            ...
            <input type="text" id="inputcname" name="cname" class="form-control"
                   placeholder="姓名" required="" readonly value="<%=request.getAttribute("cname")%>">
            <label for="inputclphone">电话</label>
			<input type="text" id="inputclphone" name="clphone" class="form-control"
			       placeholder="电话" readonly value="<%=request.getAttribute("clphone")%>">
			<label for="inputcemail">邮箱</label>
			<input type="text" id="inputcemail" name="cemail" class="form-control"
			       placeholder="邮箱" required="" readonly value="<%=request.getAttribute("cemail")%>">
		</form>
		</div>
	  </div>
	</div>
