			...
			<div id="carousel-example-generic" class="carousel slide"
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img
							data-src="holder.js/1200x500?fg=FF0000&auto=yes&#777:#555&text=First slide"
							alt="First slide">
						<div class="carousel-caption">图片 1</div>
					</div>
					<div class="item">
						<img
							data-src="holder.js/1200x500?random=yes&outline=no&auto=yes&#666:#444&text=second slide"
							alt="Second slide">
						<div class="carousel-caption">图片2</div>
					</div>
					<div class="item">
						<img
							data-src="holder.js/1200x500?random=yes&outline=yes&auto=yes&#555:#333&text=Third slide"
							alt="Third slide">
